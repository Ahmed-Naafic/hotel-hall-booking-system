...
import 'package:customer_mobile/features/chat/presentation/screens/chat_screen.dart';
...
/// Communication V1 — Customer Mobile's `ChatScreen`. Covers the message
...
Map<String, dynamic> _messageJson({
  String id = 'm1',
  String senderUserId = 'customer-1',
    ...
    await tester.pumpWidget(
      _wrap((request) async {
        if (request.url.path.endsWith('/bookings/b1/messages') && request.method == 'GET') {
          return _envelope(
            [_messageJson(id: 'm1', senderUserId: 'customer-1', body: 'Hi!'), _messageJson(id: 'm2', senderUserId: 'manager-1', body: 'Hello, how can I help?')],
    ...
    await tester.pumpWidget(
      _wrap((request) async {
        ...
        if (request.url.path.endsWith('/bookings/b1/messages') && request.method == 'POST') {
          return _envelope(_messageJson(id: 'm-new', senderUserId: 'customer-1', body: 'New message'));
        }
        return _envelope({});
      }),
    );
