 ...
 * suspension and deactivation (BR-HOTEL-09), and restriction triggered by
 * invalid required information (BR-HOTEL-10).
 *
 * Suspension and deactivation are fully specified and implemented below.
 * Restriction's *detection mechanism* (what makes information "invalid,"
 * and what triggers the check) is Pending Business Decision #4 — genuinely
 * undefined. This component provides the transition capability only
 * (restrictHotel/resolveRestriction, callable through the same
 * Module-13-authorized interface as suspension); it does not invent an
 * automatic detector or a resolution workflow.
 */
